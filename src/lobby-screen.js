...
// tag and ping. The host picks the mode (FFA or PRACTICE; 1V1, 2V2 and 3V3 are
// listed but cannot be started yet), the map and the settings, then STARTS the
// round; everyone else sees the same choices, read-only. LEAVE leaves the room.
