...
export const HOLLOW_TYPES = {
 ...
 choppingBlock: { w: .7, d: .7, health: null, lowTop: true, collisionBoxes: [[0, 0, .55, .55, .6]] },
 // (The counterweight stone on the ground at the pole's short end is solid too.)
 wellSweep: { w: 6.4, d: 2.2, health: null, lowTop: true, collisionBoxes: [[0, 0, 1.9, 1.9, .9], [3, 0, .32, .32, 2.9], [4.95, 0, .7, .7, .6]] },
 waterTrough: { w: 2.2, d: .8, health: null, lowTop: true, collisionBoxes: [[0, 0, 2.1, .7, .7]] },
 ...
 stonePile: { w: 2, d: 1.6, health: null, collisionBoxes: [[0, 0, 1.8, .8, .8], [0, 0, 1.2, 1.3, .8]] }, // (a cross: the heap is round, and one box stopped bodies 0.3-0.8 m short of its stones at the corners; stage 5 review)
