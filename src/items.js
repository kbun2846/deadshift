...
//   input   'orbs'    Static's scheme: E places, LMB/Q launches, C streams, X hex.
//           'trigger' a gun: LMB/Q (or FIRE) fires or charges, RMB/Shift aims,
...
export const WEAPONS = Object.freeze([
 ...
 { id: 'rifle', kind: ITEM_KIND.WEAPON, name: 'Nominal', stats: 'RIFLE', input: 'trigger', smoothCursor: true, adsFire: true,
   touchButtons: { extended: { label: 'EXTEND', binding: 'X', key: 'KeyX', aria: `Load ${RIFLE.extendedMagazine}-round magazine` }, grenade: { label: 'GRENADE', binding: 'E', key: 'KeyE', aria: 'Throw grenade' }, aim: { binding: 'RMB / SHIFT' } },
 ...
 { id: 'shotgun', kind: ITEM_KIND.WEAPON, name: 'Ballast', stats: 'SHOTGUN', input: 'trigger', smoothCursor: false, tutorial: { targetHp: 400 }, storesCharge: true,
   touchButtons: { extended: { label: 'LOCK', binding: 'SHIFT / RMB', key: 'MouseRight', aria: 'Store charge' }, grenade: { label: 'DOUBLE', binding: 'E', key: 'KeyE', aria: 'Fire both shells' }, aim: { binding: 'RMB' } },
