...
export const WEAPONS = Object.freeze([
 { id: 'static', kind: ITEM_KIND.WEAPON, name: 'Static', stats: 'RULES', input: 'orbs', smoothCursor: true,
  ...
  ['Dodge','Q / DODGE','One dodge; it refills after a moment.']],
