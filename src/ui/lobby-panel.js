...
// clock, and each player with their colour, a host tag and their ping. Only the
// host's page shows the round settings (and lets them be changed), and has the
// host controls: REMOVE a player, RESET MAP (every prop, crop, bloodstain and body
