...
export const MOVE_STICK = Object.freeze({ travel: .4, dead: .16, curve: 1.45, smoothing: .09 });
...
export const TOUCH_CLUSTER = Object.freeze({ fire: 122, gap: 6, ring: 66, segmentGap: 4, landscapeBase: 0, portraitBase: 98 });
